...
- **기존 연구 활용**:
    - 다양한 압축 메모리 형태가 제안되었지만, 본 연구에서는 단순성과 효율성을 위해 associative matrix를 활용한다. <a href="https://arxiv.org/abs/2011.07831" target="_blank">(Schlag et al., 2020)</a>
